        ...
        <div class="row">
            <div class="col-md-9" style="border-radius: 10px;">
                ...
                <div class="row row-space">
                    <div class="col-md-4 text-center">
                        <a href="./jurnal.php">
                            <figure class="hover-img text-center">
                                <img src="./image/journal.jpg" alt style="width: 100%; height: 20%;"/>
                                <figcaption style="font-family: Calibri; font-size: small;">
                    ...
                    <div class="col-md-4 text-center">
                        <a href="./hasil.php">
                            <figure class="hover-img">
                                <img src="./image/laporan2.jpg" alt style="width: 100%; height: 20%;"/>
                                <figcaption style="font-family: Calibri; font-size: small;">
                    ...
                    <div class="col-md-4 text-center">
                        <figure class="hover-img">
                            <img src="./image/librarycafe.jpg" alt style="width: 100%; height: 20%;"/>
                            <figcaption>
                    ...
                    <div class="col-md-4 text-center">
                        <figure class="hover-img">
                            <img src="./image/pks.jpg" alt style="width: 100%; height: 20%;"/>
                            <figcaption style="font-family: Calibri; font-size: small;">
            ...
            <div class="col-md-2 text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <img src="./image/pengumuman/Logo_HUT_BPKP__38-1-removebg-preview (1).png" alt style="width: 100%;"/>
                    </div>
                    <p>
                        &nbsp;
                    </p>
                    <div class="col-md-12">
                        <img src="./image/pengumuman/Call for Paper - Jurnal Pengawasan_resize.jpeg" alt style="width: 100%;"/>
                    </div>
                    <p>
                        &nbsp;
                    </p>
                    <div class="col-md-12">
                        <a href="#"><button type="button" class="btn btn-orange" style="color: #263C92;">Pengumuman Lainnya</button></a>
                    </div>
                </div>
            </div>
        </div>
